...
void HAL_FDCAN_TxBufferAbortCallback(FDCAN_HandleTypeDef *hfdcan, uint32_t BufferIndexes)
{
  ...
  // uart_printf("! FDCAN TxBufferAbort\n");
}
...
//	FDCAN1_RXFilter.FilterID2=0x555;
  ...
  // assert_param(HAL_FDCAN_ConfigFifoWatermark(&hfdcan1, FDCAN_CFG_RX_FIFO0, 1) == HAL_OK);
	assert_param(HAL_FDCAN_ActivateNotification(&hfdcan1, FDCAN_IT_RX_FIFO0_NEW_MESSAGE, 0)==HAL_OK);
  assert_param(HAL_FDCAN_ActivateNotification(&hfdcan1, FDCAN_IT_TX_EVT_FIFO_ELT_LOST, 0)==HAL_OK);


  assert_param(HAL_FDCAN_ActivateNotification(&hfdcan1, FDCAN_IT_RAM_ACCESS_FAILURE, 0)==HAL_OK);
  assert_param(HAL_FDCAN_ActivateNotification(&hfdcan1, FDCAN_IT_DATA_PROTOCOL_ERROR, 0)==HAL_OK);
  assert_param(HAL_FDCAN_ActivateNotification(&hfdcan1, FDCAN_IT_ARB_PROTOCOL_ERROR, 0)==HAL_OK);

	assert_param(HAL_FDCAN_Start(&hfdcan1)==HAL_OK);

	FDCAN2_RXFilter.IdType=FDCAN_STANDARD_ID;
	FDCAN2_RXFilter.FilterIndex=0;           
	FDCAN2_RXFilter.FilterType=FDCAN_FILTER_RANGE;
	FDCAN2_RXFilter.FilterConfig=FDCAN_FILTER_TO_RXFIFO0;
	FDCAN2_RXFilter.FilterID1=0x000;
	FDCAN2_RXFilter.FilterID2=0x7FF;
	assert_param(HAL_FDCAN_ConfigFilter(&hfdcan2,&FDCAN2_RXFilter)==HAL_OK);
  // assert_param(HAL_FDCAN_ConfigFifoWatermark(&hfdcan2, FDCAN_CFG_RX_FIFO0, 1) == HAL_OK);
	assert_param(HAL_FDCAN_ActivateNotification(&hfdcan2, FDCAN_IT_RX_FIFO0_NEW_MESSAGE, 0)==HAL_OK);
  assert_param(HAL_FDCAN_ActivateNotification(&hfdcan2, FDCAN_IT_TX_EVT_FIFO_ELT_LOST, 0)==HAL_OK);


  assert_param(HAL_FDCAN_ActivateNotification(&hfdcan2, FDCAN_IT_RAM_ACCESS_FAILURE, 0)==HAL_OK);
  assert_param(HAL_FDCAN_ActivateNotification(&hfdcan2, FDCAN_IT_DATA_PROTOCOL_ERROR, 0)==HAL_OK);
